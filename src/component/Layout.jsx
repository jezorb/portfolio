...
const Layout = () => {
  return (
    ...
    <div className='min-h-screen bg-[#b1b1b1] px-4 sm:px-6 md:px-10 py-5 font-mono'>
      ...
      <div className='relative bg-[#fdfdfd] w-full max-w-[1400px] mx-auto border-[4px] border-black shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] flex flex-col overflow-hidden' >
        ...
        <div className="relative z-10 flex flex-col gap-10">
          ...
          {/* Education + Languages responsive flex */}
          <div className='flex flex-col lg:flex-row justify-center items-start lg:items-center gap-10 mx-auto w-full lg:w-[90%] mb-10 px-2 sm:px-4'>
            <Education className="w-full lg:w-1/2"/>
            <Languages className="w-full lg:w-1/2"/>
          </div>
